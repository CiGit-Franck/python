...
index = int(age)
if index < 0 or index > len(low_weights_boys)-1:
    print("La vérification des constantes de votre nourrisson est prévue que de 0 à 60 mois !")
    sys.exit(0)
    
def retour_poids(min, max, val):
    if val >= min and val <= max:
        print("Le poids de votre nourrisson (" + str(val) + " kg) est dans la norme !")
    else:
        print("Le poids de votre nourrisson (" + str(val) + " kg) est hors norme !")

def retour_taille(min, max, val):
    if val >= min and val <= max:
        print("Le poids de votre nourrisson (" + str(val) + " cm) est dans la norme !")
    else:
        print("Le poids de votre nourrisson (" + str(val) + " cm) est hors norme !")
    
def retour_crane(min, max, val):
    if val >= min and val <= max:
        print("Le périmètre cranien de votre nourrisson (" + str(val) + " cm) est dans la norme !")
    else:
        print("Le périmètre craniende votre nourrisson (" + str(val) + " cm) est hors norme !")
    

# fille
if genre == 'f':
    # poids
    min = low_weights_girls[index]
    max = high_weights_girls[index]
    val = float(poids)
    print("La norme de poids pour une fille de " + age + " mois est situé entre " + str(min) + " kg et " + str(max) + " kg")
    retour_poids(min, max, val)
    print()
    # taille   
    min = low_heights_girls[index]
    max = high_heights_girls[index]
    val = float(taille)
    print("La norme de taille pour une fille de " + age + " mois est situé entre " + str(min) + " cm et " + str(max) + " cm")
    retour_taille(min, max, val)
    print()
    # crane    
    min = low_skulls_girls[index]
    max = high_skulls_girls[index]
    val = float(crane)
    print("La norme de périmètre cranien pour une fille de " + age + " mois est situé entre " + str(min) + " cm et " + str(max) + " cm")
    retour_crane(min, max, val)
# garçon
elif genre == 'g':
    # poids
    min = low_weights_boys[index]
    max = high_weights_boys[index]
    val = float(poids)
    print("La norme de poids pour une garçon de " + age + " mois est situé entre " + str(min) + " kg et " + str(max) + " kg")
    retour_poids(min, max, val)
    print()
    # taille   
    min = low_heights_boys[index]
    max = high_heights_boys[index]
    val = float(taille)
    print("La norme de taille pour une garçon de " + age + " mois est situé entre " + str(min) + " cm et " + str(max) + " cm")
    retour_taille(min, max, val)
    print()
    # crane    
    min = low_skulls_boys[index]
    max = high_skulls_boys[index]
    val = float(crane)
    print("La norme de périmètre cranien pour une garçon de " + age + " mois est situé entre " + str(min) + " cm et " + str(max) + " cm")
    retour_crane(min, max, val)
else:
    print("Erreur de genre !")
